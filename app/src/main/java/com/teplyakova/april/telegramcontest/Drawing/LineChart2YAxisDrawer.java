...
public class LineChart2YAxisDrawer implements ChartDrawer {

    private class YScale
    {
        long Height;
        long MaxY;
        int  Alpha;
    ...
    public LineChart2YAxisDrawer(Context context, ChartData chartData, SliderObservable observable) {
        mContext = context;
    ...
    public void draw(Canvas canvas) {
        ...
        for (ChartLine line : mLines) {
            for (YScale yScale : line.mYMaxAnimator.mYScales) {
